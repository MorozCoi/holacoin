...
const QString BITCOIN_IPC_PREFIX("holacoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click holacoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start holacoin: click-to-pay handler");
    else
...
{
    // clicking on holacoin: URLs creates FileOpen events on the Mac:
